...
# 固定对比日志（唯一的基准日志）
# ======================================================
# target_log_path = r"D:/Desktop/模型挖掘算法可靠性评价方法/BPI2020ID.xes"
...
# 输出路径
# ======================================================
# output_excel = r"D:/Desktop/模型挖掘算法可靠性评价方法/结果/BPI2020ID/HM/evaluation_results_single_reference_HM.xlsx"
model_dir = r"F:/402/模型挖掘算法可靠性评价方法/结果/Synthetic log6/incremental_models_IMi"
# os.makedirs(model_dir, exist_ok=True)
